...
import 'package:web_framework/model_tugas/model_login_tgs.dart';
...
import 'package:web_framework/tugas_page/page_register_api_tgs.dart';
  ...
  Future<ModelLoginTugas?> loginAccount() async {
    ...
    try {
      ...
      http.Response response = await http
          .post(Uri.parse('http://192.168.43.36/edukasi_server/login.php'), body: {
